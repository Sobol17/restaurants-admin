    ...
    <div class="history-view">
      <div class="history-block">
        <div class="history-infos">
          <InfoCard :title="historyData.totalOrders" subtitle="Количество заказов"/>
          <InfoCard :title="historyData.totalRevenue" subtitle="Выручка за период"/>
        </div>
      </div>
      ...
      <div v-if="historyData.orders?.length" class="history-list">
        <HistoryCard
      ...
      <div v-else class="history-list--empty">
        Нет данных
      </div>
    </div>
